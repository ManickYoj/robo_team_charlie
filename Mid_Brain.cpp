...
int main(int argc, char **argv)
{
  ...
  pub_vel = new ros::Publisher(n.advertise<std_msgs::Int8MultiArray>("obst/cmd_vel", 1000));
  pub_ang = new ros::Publisher(n.advertise<std_msgs::Int8MultiArray>("obst/cmd_dir", 1000));
